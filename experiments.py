...
if __name__ == "__main__":
    ...
    # Run experiments
    for pars in product([0.005, 0.01], [50, 100], [0.1, 0.5], [0.05, 0.1], [0.2, 0.3], [0.5, 0.7]):
        lr, step, gamma, score, nms, predconf = pars
        print(" @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ now experimenting with @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ "+str(pars))
        pytorch_params = {"modelType": "maskrcnn", "score": score, "nms": nms, "predconf": predconf, "LR": lr, "STEP": step, "GAMMA": gamma}
